...
class RecipeReviewCard extends React.Component {
  ...
  handleFavorite = (key) => {
    console.log(key);
    if (this.state.favorit==='secondary'){
      this.state.favorit = 'default';
    }else{
      this.state.favorit = 'secondary';
    }
    this.setState({favorit : this.state.favorit});
    console.log(this.state.favotit);
  };
      ...
      <Card className={classes.card}>
        ...
        <CardActions className={classes.actions} disableActionSpacing>
          <IconButton onClick={this.handleFavorite} aria-label="Add to favorites">
            <FavoriteIcon  color={this.state.favorit} />
          </IconButton>
